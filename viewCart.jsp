...
<body style=" overflow-x:hidden; overflow-y:auto;margin:0;" >
	...
	<header>
		<div class="cart">
			<nav>
				<a href="memberPage.jsp"><ion-icon name="arrow-back-outline"
...
<%if(quantity!=0){ %>
<button class="button-41" role="button" onClick="location.href='buyNow.jsp'">Proceed To Checkout</button>
<%}
else{
%><h2 style="margin:auto;padding:15px;text-align:center;color:#F57A87;">Your cart is empty!</h2>
<h4 style="margin:auto;text-align:center;font-size:18px;">Explore our wide selection and find something you like</h4>
<%} %>
	</div>
